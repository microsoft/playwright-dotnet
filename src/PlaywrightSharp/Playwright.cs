...
namespace PlaywrightSharp
{
    ...
    public sealed class Playwright : IPlaywright, IDisposable, IChannelOwner<Playwright>
    {
        ...
        internal Transport.Connection Connection { get; set; }
        ...
        {
            var connection = new Transport.Connection(loggerFactory, scheduler);
        ...
        public static Task InstallAsync(ILoggerFactory loggerFactory = null) => Transport.Connection.InstallAsync(loggerFactory);
