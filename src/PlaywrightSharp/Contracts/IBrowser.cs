...
namespace PlaywrightSharp
{
    ...
    public partial interface IBrowser
    {
        ...
        /// <returns><see cref="IBrowser.NewContextAsync(bool?, bool?, ColorScheme, float?, IEnumerable{KeyValuePair{string, string}}, Geolocation, bool?, HttpCredentials, bool?, bool?, bool?, string, bool?, IEnumerable{string}, Proxy, bool?, string, string, RecordVideoSize, string, string, string, string)"/>.</returns>
