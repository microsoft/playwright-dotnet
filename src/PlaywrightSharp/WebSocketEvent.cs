...
{
    /// <summary>
    /// WebSocket events for <see cref="WebSocketExtensions.WaitForEventAsync{T}(IWebSocket, PlaywrightEvent{T}, Func{T, bool}, float?)"/>.
    /// </summary>
    public static class WebSocketEvent
    {
        ...
        /// </summary>
        public static PlaywrightEvent<EventArgs> Close { get; } = (PlaywrightEvent<EventArgs>)Events["Close"];

        /// <summary>
        /// <see cref="PlaywrightEvent{T}"/> representing a <see cref="IWebSocket.FrameReceived"/>.
        /// </summary>
        public static PlaywrightEvent<IWebSocketFrame> FrameReceived { get; } = (PlaywrightEvent<IWebSocketFrame>)Events["FrameReceived"];

        /// <summary>
        /// <see cref="PlaywrightEvent{T}"/> representing a <see cref="IWebSocket.FrameSent"/>.
        /// </summary>
        public static PlaywrightEvent<IWebSocketFrame> FrameSent { get; } = (PlaywrightEvent<IWebSocketFrame>)Events["FrameSent"];

        /// <summary>
        /// <see cref="PlaywrightEvent{T}"/> representing a <see cref="IWebSocket.SocketError"/>.
        /// </summary>
        public static PlaywrightEvent<string> SocketError { get; } = (PlaywrightEvent<string>)Events["SocketError"];
