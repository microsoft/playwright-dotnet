...
namespace PlaywrightSharp.Tests.Webkit
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Usage", "xUnit1000:Test classes must be public", Justification = "Disabled")]class ProvisionalTests : PlaywrightSharpPageBaseTest
    {
        /// <inheritdoc/>
