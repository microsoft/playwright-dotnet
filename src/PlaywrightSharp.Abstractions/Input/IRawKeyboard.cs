...
namespace PlaywrightSharp.Input
{
    ...
    internal interface IRawKeyboard
    {
        ...
        /// <returns>A <see cref="Task"/> that completes when the message is confirmed by the browser.</returns>
        Task KeyDownAsync(Modifier[] modifiers, string code, int keyCode, int keyCodeWithoutLocation, string key, int location, bool autoRepeat, string text);
        ...
        /// <param name="location">The location.</param>
        /// <returns>A <see cref="Task"/> that completes when the message is confirmed by the browser.</returns>
        Task KeyUpAsync(Modifier[] modifiers, string code, int keyCode, int keyCodeWithoutLocation, string key, int location);
    }
}
