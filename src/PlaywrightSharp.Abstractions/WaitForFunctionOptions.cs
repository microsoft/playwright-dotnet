...
{
    /// <summary>
    /// Options for <see cref="IPage.WaitForFunctionAsync(string, WaitForFunctionOptions, object[])"/>.
    /// </summary>
    public class WaitForFunctionOptions
    {
        ...
        /// <summary>
        /// An interval at which the function is executed. If no value is specified will use <see cref="Polling"/>.
        /// </summary>
