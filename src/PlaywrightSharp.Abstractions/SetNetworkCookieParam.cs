namespace PlaywrightSharp
{
    ...
    /// Cookie data.
    /// </summary>
    /// <seealso TODOcref="Page.SetContentAsync(string, NavigationOptions)"/>
    /// <seealso TODOcref="Page.DeleteCookieAsync(SetNetworkCookieParam[])"/>
    /// <seealso TODOcref="Page.GetCookiesAsync(string[])"/>
