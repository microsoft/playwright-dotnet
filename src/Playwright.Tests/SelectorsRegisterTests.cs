...
namespace Microsoft.Playwright.Tests
{
    ...
    public class SelectorsRegisterTests : PageTestEx
    {
        ...
        public async Task ShouldWork()
        {
            ...
            var exception = Assert.ThrowsAsync<PlaywrightException>(async () => await page.QuerySelectorAsync("tAG=DIV"));
        ...
        {
            var exception = Assert.ThrowsAsync<PlaywrightException>(async () => await Page.QuerySelectorAsync("neverregister=ignored"));
            ...
            exception = Assert.ThrowsAsync<PlaywrightException>(async () => await Playwright.Selectors.RegisterAsync("$", new SelectorsRegisterOptions { Script = createDummySelector }));
            ...
            exception = Assert.ThrowsAsync<PlaywrightException>(async () => await Playwright.Selectors.RegisterAsync("dummy", new SelectorsRegisterOptions { Script = createDummySelector }));
            StringAssert.Contains("\"dummy\" selector engine has been already registered", exception.Message);

            exception = Assert.ThrowsAsync<PlaywrightException>(async () => await Playwright.Selectors.RegisterAsync("css", new SelectorsRegisterOptions { Script = createDummySelector }));
