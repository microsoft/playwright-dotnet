...
namespace Microsoft.Playwright.Tests
{
    ...
    public class ProxyTests : PlaywrightTestEx
    {
        ...
        public async Task ShouldExcludePatterns()
        {
            ...
            Assert.ThrowsAsync<PlaywrightException>(async () => await page.GotoAsync("http://non-existent1.com/target.html"));
            Assert.ThrowsAsync<PlaywrightException>(async () => await page.GotoAsync("http://sub.non-existent2.com/target.html"));
            Assert.ThrowsAsync<PlaywrightException>(async () => await page.GotoAsync("http://foo.zone/target.html"));
        }
    }
}
