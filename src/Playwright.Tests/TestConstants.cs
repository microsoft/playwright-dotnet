...
namespace Microsoft.Playwright.Tests
{
    internal static class TestConstants
    {
        ...
        internal static readonly bool IsWebKit = BrowserName == BrowserTypes.Webkit;
        internal static readonly bool IsFirefox = BrowserName == BrowserTypes.Firefox;
        internal static readonly bool IsChromium = BrowserName == BrowserTypes.Chromium;
